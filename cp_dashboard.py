...
with tab2:
    ...
    def preprocess_text(text):
        ...
        # text = re.sub(r'[.,\/\-\(\)]', ' ', text)
        text = re.sub(r'\b(?:ikea|the|ok|la|good|bad|etc|covid|RM|am|pm|re|30am|50am|p|e|je|kan|s|0|u|sia|Mr|Q|well|h|O|furniture|food|price|nice|tu|m|C|peri|tula)\b', '', text, flags=re.IGNORECASE)
